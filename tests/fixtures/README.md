...
`linux_probe.c` 用于验证动态 ELF 的完整 Gum manifest：DNS、阻塞与非阻塞 connect、延迟 SOCKS 握手、send/recv、fcntl/ioctl、open/open64/openat/openat64/creat、read/write、rename/unlink 变体、mmap/mprotect/munmap、execve 失败路径，以及 fork+exec、posix_spawn/posix_spawnp 后代递归注入。
